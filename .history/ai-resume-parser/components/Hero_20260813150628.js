  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          {/* Main resume card */}
          <div className="glass-strong relative z-10 rounded-3xl p-6 shadow-glass">
          ...
          <motion.div
            ...
            className="glass absolute -left-10 top-0 z-20 hidden -translate-y-1/2 items-center gap-2 rounded-2xl px-4 py-3 shadow-glow sm:flex"
          >
